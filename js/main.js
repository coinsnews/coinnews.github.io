...
function renderSinglePostPage() {
  ...
  const cleanArticleUrl = `https://coinnews.github.io/blog/${post.slug}/`;
  ...
  if (schemaElem) {
    const schemaData = {
      ...
      "image": [`https://coinnews.github.io${post.image.svg}`],
      ...
      "publisher": {
        ...
        "logo": {
          "@type": "ImageObject",
          "url": "https://coinnews.github.io/images/hero-btc.svg"
        }
      }
    };
